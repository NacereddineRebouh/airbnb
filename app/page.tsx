...
import sr from "../public/images/1.jpg";
...
export default function Home() {
  return (
    <div className="relative mx-10  lg:mx-20 my-8 flex-1 overflow-visible">
      {/* List of houses */}
      <div className=" relative grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg2:grid-cols-4 3xl:grid-cols-5 4xl:grid-cols-6 gap-3 scroll-smooth max-w-[2350px] mx-auto overflow-visible auto-rows-[minmax(100px,auto-fit)] ">
