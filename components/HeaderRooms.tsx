...
export default function Header({}: Props) {
  ...
  return (
    <div className="w-[100%] bg-white mobile:border-[1px]">
      ...
      {/* Mobile Search Bar */}
      <div className="flex h-20 cursor-pointer flex-row items-center justify-center font-semibold mobile:collapse mobile:h-0">
        <div className="mx-6 mt-4 flex h-14 w-full flex-row items-center justify-between rounded-full border-[1px] shadow-lg">
